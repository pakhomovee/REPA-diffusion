...
# from scratch to 200k. GPUs 4-7. Hyperparameters identical to the existing
# constant-λ REPA baseline at runs/celeba_sit_b2_repa_dinov2b_gpus4-7 so the
# FID comparison is apples-to-apples.
#
...
#
# Output: runs/celeba_sit_b2_repa_sigma_hard_gpus4-7/
...
"$ACCELERATE" launch \
  ...
  --output-dir="../runs" \
  --logging-dir="logs" \
  --exp-name="celeba_sit_b2_repa_sigma_hard_gpus4-7" \
