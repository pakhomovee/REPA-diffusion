...
This section compares the impact of \textbf{REPA} vs.\ \textbf{REPA-$\Sigma$} ($\pm\,\lambda$-anneal), against the
diffusion baseline, on convergence speed (FID/KID) across three single-domain datasets spanning a
...
This section compares the impact of \textbf{REPA} vs.\ \textbf{REPA-$\Sigma$} on the learned feature maps and
generations across the three datasets. PCA maps show REPA preserves semantic, face-centred structure through the
